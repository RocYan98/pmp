...
var vm = new Vue({
    ...
    methods: {
        ...
        add: function(){
            vm.showList = false;
            vm.title = "新增";
            vm.menu = {parentName:null,parentId:-1,type:1,orderNum:0};
            vm.getMenu();
        },
...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '父级菜单', field: 'parentName', align: 'center', valign: 'middle', sortable: true, width: '100px'},
        ...
        {title: '菜单链接url', field: 'url', align: 'center', valign: 'middle', sortable: true, width: '160px'},
        {title: '授权编码', field: 'perms', align: 'center', valign: 'middle', sortable: true}]
    return columns;
};
